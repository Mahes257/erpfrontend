...
import { PAGE_SIZE_OPTIONS } from '../../utils/followUpConstants';
import { getCellValue } from '../../utils/followUpHelpers';
      ...
      <td key={col.key} style={style} className={`px-4 py-3 border-b border-slate-100 ${cellClass} ${alignClass}`}>
        {col.key === 'actions' ? (
          <ActionMenu
            ...
            align="right"
            ariaLabel={`Actions for ${row.leadName || 'follow-up'}`}
          />
        ) : renderers[col.key] ? (
